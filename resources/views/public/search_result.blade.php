...
@section('title', 'Hasil Pencarian untuk "' . ($query ?? 'Semua Artikel') . '"')
...
<main class="pt-24 pb-20 md:pt-32">
    ...
    <section class="relative py-24 overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-4 text-gold drop-shadow-lg font-khusus">
                Hasil Pencarian
            </h1>
            <p class="text-lg md:text-xl text-text-secondary max-w-3xl mx-auto">
                Menemukan {{ $articles->total() }} artikel yang relevan dengan kata kunci "{{ $query }}".
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-dark-bg">
        <div class="container mx-auto px-6">
            @if($articles->isEmpty())
            <p class="text-center text-text-secondary text-xl">Tidak ada artikel yang ditemukan.</p>
            @else
