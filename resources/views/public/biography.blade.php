...
<main class="pt-24 pb-20 md:pt-32 bg-dark-bg text-text-primary">
    <div class="container mx-auto px-6">
            ...
            <div class="max-w-4xl mx-auto bg-card-bg rounded-lg shadow-xl overflow-hidden p-8 md:p-12 mt-10">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start mb-10">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <div class="mt-4 text-text-secondary text-sm md:text-base">
                            ...
                            <p class="mb-1">
                                <i class="fas fa-map-marker-alt text-gold mr-2"></i> Lahir di {{ $biography->birth_place }}, {{ \Carbon\Carbon::parse($biography->birth_date)->format('d F Y') }}
                            </p>
                            @endif
                ...
                <div class="mt-8 pt-6 border-t border-gray-700/50">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="#" class="text-text-secondary hover:text-gold transition-colors duration-200" title="Instagram">
                            <i class="fab fa-instagram text-2xl"></i>
                        </a>
                        <a href="#" class="text-text-secondary hover:text-gold transition-colors duration-200" title="Facebook">
                            <i class="fab fa-facebook-square text-2xl"></i>
                        </a>
                        <a href="#" class="text-text-secondary hover:text-gold transition-colors duration-200" title="YouTube">
        ...
        @else
            ...
            <div class="max-w-4xl mx-auto text-center py-20 bg-card-bg rounded-lg shadow-xl">
                <h2 class="text-2xl font-bold text-text-primary mb-4">Biografi belum tersedia.</h2>
                <p class="text-text-secondary">Mohon maaf, halaman biografi Ustadz Andre Raditya sedang dalam proses penyusunan.</p>
            </div>
        @endif
    </div>
</main>
